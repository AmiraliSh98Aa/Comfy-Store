    ...
    <div className='grid lg:grid-cols-2 gap-24 items-center'>
      <div>
        ...
        <p className="mt-8 max-w-xl text-lg leading-8">
          Lorem ipsum dolor sit, amet consectetur adipisicing elit. Eveniet corrupti sapiente perspiciatis quae aliquid asperiores iusto assumenda similique cum eos!
        </p>
        <div className="mt-10">
